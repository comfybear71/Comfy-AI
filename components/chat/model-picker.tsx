...
const PROVIDERS: Provider[] = ["groq", "deepseek", "anthropic", "xai", "ollama-cloud"]
    ...
    <div className="relative">
      ...
      >
        ...
        <span className="text-[10px] text-gray-500 bg-gray-700 px-1.5 py-0.5 rounded">
          {{ anthropic: "claude", xai: "grok", groq: "groq", deepseek: "deepseek", "ollama-cloud": "cloud" }[selected.provider]}
        </span>
